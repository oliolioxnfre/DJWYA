...
class VibeClassifier:
    ...
    SONIC_DNA = {
        ...
        'tropical-house':    {'intensity': 2, 'euphoria': 10, 'space': 8, 'pulse': 7, 'chaos': 1, 'swing': 6},
        ...
        'g-house':           {'intensity': 8, 'euphoria': 2, 'space': 3, 'pulse': 9, 'chaos': 4, 'swing': 9},
        'afro-house':        {'intensity': 4, 'euphoria': 6, 'space': 7, 'pulse': 8, 'chaos': 3, 'swing': 10},
        'organic-house':     {'intensity': 2, 'euphoria': 7, 'space': 9, 'pulse': 7, 'chaos': 2, 'swing': 9},
        'chicago-house':     {'intensity': 5, 'euphoria': 7, 'space': 5, 'pulse': 9, 'chaos': 4, 'swing': 10},
        'disco-house':       {'intensity': 5, 'euphoria': 10, 'space': 5, 'pulse': 8, 'chaos': 2, 'swing': 10},
        'nu-disco':          {'intensity': 4, 'euphoria': 9, 'space': 6, 'pulse': 8, 'chaos': 3, 'swing': 10},
        'lo-fi-house':       {'intensity': 3, 'euphoria': 5, 'space': 9, 'pulse': 7, 'chaos': 5, 'swing': 8},
        'funky-house':       {'intensity': 4, 'euphoria': 9, 'space': 4, 'pulse': 8, 'chaos': 3, 'swing': 10},
        'hard-house':        {'intensity': 10, 'euphoria': 5, 'space': 1, 'pulse': 10, 'chaos': 6, 'swing': 6},
        'jazz-house':        {'intensity': 3, 'euphoria': 8, 'space': 7, 'pulse': 6, 'chaos': 5, 'swing': 10},
        'rally-house':       {'intensity': 7, 'euphoria': 6, 'space': 4, 'pulse': 9, 'chaos': 5, 'swing': 7},
        'witch-house':       {'intensity': 9, 'euphoria': 3, 'space': 10, 'pulse': 5, 'chaos': 6, 'swing': 4},
        ...
        'downtempo':         {'intensity': 1, 'euphoria': 6, 'space': 10, 'pulse': 4, 'chaos': 1, 'swing': 7},
        'idm':               {'intensity': 5, 'euphoria': 4, 'space': 8, 'pulse': 0, 'chaos': 10, 'swing': 6},
        'trip-hop':          {'intensity': 3, 'euphoria': 4, 'space': 8, 'pulse': 5, 'chaos': 4, 'swing': 9},
        'chillstep':         {'intensity': 2, 'euphoria': 8, 'space': 10, 'pulse': 3, 'chaos': 2, 'swing': 5},
        'psydub':            {'intensity': 4, 'euphoria': 7, 'space': 10, 'pulse': 4, 'chaos': 7, 'swing': 7},
        'vaporwave':         {'intensity': 1, 'euphoria': 7, 'space': 10, 'pulse': 3, 'chaos': 3, 'swing': 5},
        'synthwave':         {'intensity': 6, 'euphoria': 8, 'space': 9, 'pulse': 8, 'chaos': 2, 'swing': 4},
        'illbient':          {'intensity': 5, 'euphoria': 1, 'space': 10, 'pulse': 3, 'chaos': 8, 'swing': 4},
        ...
        'outrun':            {'intensity': 7, 'euphoria': 8, 'space': 8, 'pulse': 9, 'chaos': 2, 'swing': 3},
        'retrowave':         {'intensity': 5, 'euphoria': 8, 'space': 9, 'pulse': 8, 'chaos': 2, 'swing': 3},
        'chillsynth':        {'intensity': 1, 'euphoria': 7, 'space': 10, 'pulse': 6, 'chaos': 2, 'swing': 4},
        'musique-concrete':  {'intensity': 6, 'euphoria': 0, 'space': 10, 'pulse': 0, 'chaos': 10, 'swing': 3},
